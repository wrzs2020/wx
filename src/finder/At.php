...
class At
{
    ...
    {
        $iniFile = WxFinderConfig::$wxFinderConfigPath . '/wx_fander_access_token.ini';
    ...
    {
        $url = WxFinderConfig::$aturl . '?grant_type=' . WxFinderConfig::$grant_type . '&appid=' . WxFinderConfig::$appid . '&secret=' . WxFinderConfig::$secret;
        $s = Curl::_get($url);
