...
class Sat
{
    ...
    {
        $iniFile = WxStoreConfig::$wxStoreConfigPath . '/wx_store_stable_access_token.ini';
    ...
    {
        $url = WxStoreConfig::$saturl . '?grant_type=' . WxStoreConfig::$grant_type . '&appid=' . WxStoreConfig::$appid . '&secret=' . WxStoreConfig::$secret;
        $s = Curl::_get($url);
