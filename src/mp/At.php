...
class At
{
    ...
    {
        $iniFile = WxMpConfig::$wxMpConfigPath . '/wx_mp_access_token.ini';
    ...
    {
        $url = WxMpConfig::$aturl . '?grant_type=' . WxMpConfig::$grant_type . '&appid=' . WxMpConfig::$appid . '&secret=' . WxMpConfig::$secret;
        $s = Curl::_get($url);
