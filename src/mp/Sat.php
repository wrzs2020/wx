...
class Sat
{
    ...
    {
        $iniFile = WxMpConfig::$wxMpConfigPath . '/wx_mp_stable_access_token.ini';
    ...
    {
        $url = WxMpConfig::$saturl . '?grant_type=' . WxMpConfig::$grant_type . '&appid=' . WxMpConfig::$appid . '&secret=' . WxMpConfig::$secret;
        $s = Curl::_get($url);
