...
class At
{
    ...
    {
        $iniFile = WxOpenPfConfig::$wxOpenPfConfigPath . '/wx_openpf_access_token.ini';
    ...
    {
        $url = WxOpenPfConfig::$aturl . '?grant_type=' . WxOpenPfConfig::$grant_type . '&appid=' . WxOpenPfConfig::$appid . '&secret=' . WxOpenPfConfig::$secret;
        $s = Curl::_get($url);
