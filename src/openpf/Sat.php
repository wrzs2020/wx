...
class Sat
{
    ...
    {
        $iniFile = WxOpenPfConfig::$wxOpenPfConfigPath . '/wx_openpf_stable_access_token.ini';
    ...
    {
        $url = WxOpenPfConfig::$saturl . '?grant_type=' . WxOpenPfConfig::$grant_type . '&appid=' . WxOpenPfConfig::$appid . '&secret=' . WxOpenPfConfig::$secret;
        $s = Curl::_get($url);
